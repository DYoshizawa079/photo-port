...
function PhotoList({ category }) {
    ...
    /*  filter() is used to return array items that only meet a particular criteria.
        Items are returned as an array.
        In this case, returns only photos that fit a certain category.
     */
